...
const AddProd = () => {
    ...
    return (
        <form onSubmit={handleSubmit(handleSubmitt)} encType="multipart/form-data" className="w-full relative top-2 max-w-lg mx-auto p-4 space-y-6">
            ...
            <div>
                <label className="block text-sm font-bold text-gray-700">Dimension</label>
                <input
                    type="text"
            ...
            <div>
                <label className="block text-sm font-bold text-gray-700">Material</label>
                <input
                    type="text"
            ...
            <div>
                <label className="block text-sm font-bold text-gray-700">Sale Percentage</label>
                <input
                    type="number"
                    name="salePercentage"
            ...
            <div
                className={`cursor-pointer inline-block px-4 py-2 rounded-md text-white transition duration-300 
        ${showCategories ? ' bg-blue-500 text-white py-2 px-4 rounded-md shadow-sm hover:bg-blue-600' : 'bg-green-500 hover:bg-green-400'}`}
                ...
                <div>
                    ...
                    <div className="mb-4">
                        ...
                        <select
                            ...
                            className={`border ${errors.parentCategory ? "border-red-500" : "border-gray-300"
                                } rounded p-2 w-full`}
                        >
