...
const Signup = () => {
  ...
  const onSubmit = async (data) => {
    ...
    const { email, password, name, contact, address, gender } = data;
                  ...
                  <input
                    ...
                    {...register("phone", {
                      ...
                      pattern: {
                        value: /^\+?[1-9]\d{1,14}$/,
                        message:
                          "Please enter country code with no spaces",
                      },
                    })}
                  />
                  {errors.phone && (
        ...
        >
          ...
          <div className="flex justify-between ">
            {step > 0 ? (
              <button
                onClick={handlePrev}
                className="w-1/4 py-2 bg-ashGray text-outerSpace font-semibold rounded-md hover:bg-outerSpace hover:text-ashGray transition duration-300"
              >
                Back
              </button>
            ) : (
