        ...
        >
          ...
          <div className="md:w-1/2">
            ...
            {product.salePercentage > 0 && (
              <span
                style={{ marginTop: "5rem" }}
                className="text-red-500 font-semibold text-lg absolute top-4 left-4 bg-red-200 px-2 py-1 rounded-lg"
              >
              ...
              {product.productImg.map((imgSrc, index) => (
                <img
                  ...
                  className={`w-16 h-16 object-cover cursor-pointer border ${
                    mainImage === imgSrc ? "border-blue-500" : "border-gray-300"
                  }`}
          ...
          <div className="md:w-1/2 space-y-4">
            ...
            <div className="flex gap-4 mt-4">
              ...
              <Link to="/checkout">
                <button className="bg-gray-300 border border-gray-300 rounded-lg px-6 py-3 font-semibold hover:bg-gray-100">
                  Buy It Now
                </button>
              </Link>
            </div>
